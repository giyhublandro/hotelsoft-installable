...
Public Class User
    ...
    'insert a new user
    Public Function insertUser(ByVal CODE_UTILISATEUR As String, ByVal NOM_UTILISATEUR As String, ByVal GRIFFE_UTILISATEUR As String, ByVal CATEG_UTILISATEUR As String, ByVal AGENCE_TRAV_NUMBER As Integer,
                               ByVal AGENCE_CREATE_NUMBER As Integer, ByVal PASSWORD_UTILISATEUR As String, ByVal DEBUT_ACCES As Date, ByVal FIN_ACCES As Date, ByVal NOM_CONNEXION As String,
                               ByVal DATE_CHANGE_PWD As Date, ByVal DATE_CREATION As Date, ByVal DATE_EXPIRATION As Date, ByVal DATE_DERNIERE_MAJ As Date, ByVal POSTE_UTILISATEUR As String,
                               ByVal CODE_UTILISATEUR_MAJ As String, ByVal ETAT_UTILISATEUR As String, ByVal CODE_UTILISATEUR_CREA As String, ByVal PEUT_FAIRE_REMISE As String,
                               ByVal PRIX_VENTE_MODIFIABLE As String, ByVal PEUT_FAIRE_DEDUCTION_CLIENT As String, ByVal PEUT_ANNULER_COMMANDE As String, ByVal PEUT_CLOTURER_MAIN_COURANTE As String,
                               ByVal CONNEXION_DISTANTE As String, ByVal PEUT_ATTRIBUER_GRATUITE As String, ByVal PEUT_MODIFIER_TAXE_SEJOUR As String, ByVal LANGUE_PAR_DEFAUT As String,
                               ByVal NUM_AGENCE As String, ByVal TELEPHONE As String) As Boolean

        Dim insertQuery As String = "INSERT INTO `utilisateurs` (`CODE_UTILISATEUR`, `NOM_UTILISATEUR`, `GRIFFE_UTILISATEUR`, `CATEG_UTILISATEUR`, `AGENCE_TRAV_NUMBER`, `AGENCE_CREATE_NUMBER`, 
        `PASSWORD_UTILISATEUR`, `DEBUT_ACCES`, `FIN_ACCES`, `NOM_CONNEXION`, `DATE_CHANGE_PWD`, `DATE_CREATION`, `DATE_EXPIRATION`, `DATE_DERNIERE_MAJ`, `POSTE_UTILISATEUR`, `CODE_UTILISATEUR_MAJ`,
        `ETAT_UTILISATEUR`, `CODE_UTILISATEUR_CREA`, `PEUT_FAIRE_REMISE`, `PRIX_VENTE_MODIFIABLE`, `PEUT_FAIRE_DEDUCTION_CLIENT`, `PEUT_ANNULER_COMMANDE`, `PEUT_CLOTURER_MAIN_COURANTE`, `CONNEXION_DISTANTE`,
        `PEUT_ATTRIBUER_GRATUITE`, `PEUT_MODIFIER_TAXE_SEJOUR`, `LANGUE_PAR_DEFAUT`, `NUM_AGENCE`, `TELEPHONE`)
        VALUES (@CODE_UTILISATEUR, @NOM_UTILISATEUR, @GRIFFE_UTILISATEUR, @CATEG_UTILISATEUR, @AGENCE_TRAV_NUMBER, @AGENCE_CREATE_NUMBER, @PASSWORD_UTILISATEUR, @DEBUT_ACCES, @FIN_ACCES, @NOM_CONNEXION, 
        @DATE_CHANGE_PWD, @DATE_CREATION, @DATE_EXPIRATION, @DATE_DERNIERE_MAJ, @POSTE_UTILISATEUR, @CODE_UTILISATEUR_MAJ, @ETAT_UTILISATEUR, @CODE_UTILISATEUR_CREA, @PEUT_FAIRE_REMISE, 
        @PRIX_VENTE_MODIFIABLE, @PEUT_FAIRE_DEDUCTION_CLIENT, @PEUT_ANNULER_COMMANDE, @PEUT_CLOTURER_MAIN_COURANTE, @CONNEXION_DISTANTE, @PEUT_ATTRIBUER_GRATUITE, @PEUT_MODIFIER_TAXE_SEJOUR, 
        @LANGUE_PAR_DEFAUT,  @NUM_AGENCE, @TELEPHONE)"
    ...
    Public Function updateUser(ByVal CODE_UTILISATEUR As String, ByVal NOM_UTILISATEUR As String, ByVal GRIFFE_UTILISATEUR As String, ByVal CATEG_UTILISATEUR As String, ByVal AGENCE_TRAV_NUMBER As Integer,
                               ByVal AGENCE_CREATE_NUMBER As Integer, ByVal PASSWORD_UTILISATEUR As String, ByVal DEBUT_ACCES As Date, ByVal FIN_ACCES As Date, ByVal NOM_CONNEXION As String,
                               ByVal DATE_CHANGE_PWD As Date, ByVal DATE_CREATION As Date, ByVal DATE_EXPIRATION As Date, ByVal DATE_DERNIERE_MAJ As Date, ByVal POSTE_UTILISATEUR As String,
                               ByVal CODE_UTILISATEUR_MAJ As String, ByVal ETAT_UTILISATEUR As String, ByVal CODE_UTILISATEUR_CREA As String, ByVal PEUT_FAIRE_REMISE As String,
                               ByVal PRIX_VENTE_MODIFIABLE As String, ByVal PEUT_FAIRE_DEDUCTION_CLIENT As String, ByVal PEUT_ANNULER_COMMANDE As String, ByVal PEUT_CLOTURER_MAIN_COURANTE As String,
                               ByVal CONNEXION_DISTANTE As String, ByVal PEUT_ATTRIBUER_GRATUITE As String, ByVal PEUT_MODIFIER_TAXE_SEJOUR As String, ByVal LANGUE_PAR_DEFAUT As String,
                               ByVal NUM_AGENCE As String, ByVal OLD_CODE_UTILISATEUR As String, ByVal TELEPHONE As String) As Boolean

        Dim insertQuery As String = "UPDATE `utilisateurs` SET CODE_UTILISATEUR=@CODE_UTILISATEUR, NOM_UTILISATEUR=@NOM_UTILISATEUR, GRIFFE_UTILISATEUR=@GRIFFE_UTILISATEUR, 
        CATEG_UTILISATEUR=@CATEG_UTILISATEUR, AGENCE_TRAV_NUMBER=@AGENCE_TRAV_NUMBER, AGENCE_CREATE_NUMBER=@AGENCE_CREATE_NUMBER, PASSWORD_UTILISATEUR=@PASSWORD_UTILISATEUR, DEBUT_ACCES=@DEBUT_ACCES, 
        FIN_ACCES=@FIN_ACCES, NOM_CONNEXION=@NOM_CONNEXION, DATE_CHANGE_PWD=@DATE_CHANGE_PWD, DATE_CREATION=@DATE_CREATION, DATE_EXPIRATION=@DATE_EXPIRATION, DATE_DERNIERE_MAJ=@DATE_DERNIERE_MAJ, 
        POSTE_UTILISATEUR=@POSTE_UTILISATEUR, CODE_UTILISATEUR_MAJ=@CODE_UTILISATEUR_MAJ, ETAT_UTILISATEUR=@ETAT_UTILISATEUR, CODE_UTILISATEUR_CREA=@CODE_UTILISATEUR_CREA, 
        PEUT_FAIRE_REMISE=@PEUT_FAIRE_REMISE, PRIX_VENTE_MODIFIABLE=@PRIX_VENTE_MODIFIABLE, PEUT_FAIRE_DEDUCTION_CLIENT=@PEUT_FAIRE_DEDUCTION_CLIENT, PEUT_ANNULER_COMMANDE=@PEUT_ANNULER_COMMANDE, 
        PEUT_CLOTURER_MAIN_COURANTE=@PEUT_CLOTURER_MAIN_COURANTE, CONNEXION_DISTANTE=@CONNEXION_DISTANTE, PEUT_ATTRIBUER_GRATUITE=@PEUT_ATTRIBUER_GRATUITE, 
        PEUT_MODIFIER_TAXE_SEJOUR=@PEUT_MODIFIER_TAXE_SEJOUR, LANGUE_PAR_DEFAUT=@LANGUE_PAR_DEFAUT, NUM_AGENCE=@NUM_AGENCE, TELEPHONE=@TELEPHONE WHERE CODE_UTILISATEUR = @OLD_CODE_UTILISATEUR"
    ...
    Public Function userProfils(ByVal CODE_UTILISATEUR As String) As DataTable

        Dim existQuery As String = "SELECT ID_UTILISATEUR_ACCESS_PROFIL, NOM_PROFIL From utilisateur_acces, utilisateur_acces_profil 
        WHERE utilisateur_acces.CODE_PROFIL = utilisateur_acces_profil.CODE_PROFIL AND utilisateur_acces_profil.CODE_UTILISATEUR=@CODE_UTILISATEUR ORDER BY NOM_PROFIL ASC"
