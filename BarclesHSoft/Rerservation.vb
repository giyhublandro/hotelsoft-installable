...
Public Class Reservation
    ...
    Public Function updateReservation(ByVal CODE_RESERVATION As String, ByVal CLIENT_ID As String, ByVal UTILISATEUR_ID As String, ByVal CHAMBRE_ID As String, ByVal AGENCE_ID As String, ByVal NOM_CLIENT As String, ByVal DATE_ENTTRE As Date, ByVal HEURE_ENTREE As DateTime, ByVal DATE_SORTIE As Date, ByVal HEURE_SORTIE As DateTime, ByVal ADULTES As Integer, ByVal NB_PERSONNES As Integer, ByVal ENFANTS As Integer, ByVal RECEVOIR_EMAIL As String, ByVal RECEVOIR_SMS As Integer, ByVal ETAT_RESERVATION As Integer, ByVal DATE_CREATION As Date, ByVal HEURE_CREATION As DateTime, ByVal MONTANT_TOTAL_CAUTION As Double, ByVal MOTIF_ETAT As String, ByVal DATE_ETAT As Date, ByVal MONTANT_ACCORDE As Double, ByVal GROUPE As String, ByVal DEPOT_DE_GARANTIE As Double, ByVal DAY_USE As Integer, ByVal MENSUEL As Integer, ByVal HEBDOMADAIRE As Integer, ByVal BC_ENTREPRISE As String, ByVal TYPE_CHAMBRE As String, Optional ByVal TYPE As String = "chambre", Optional ByVal PETIT_DEJEUNER_ROUTAGE As Double = 0, Optional ByVal CHAMBRE_ROUTAGE As String = "", Optional ByVal VENANT_DE As String = "", Optional ByVal SE_RENDANT_A As String = "", Optional ByVal RAISON As String = "", Optional ByVal SOURCE_RESERVATION As String = "", Optional ByVal ROUTAGE As String = "NON", Optional ByVal ETAT_NOTE_RESERVATION As String = "", Optional ByVal CODE_ENTREPRISE As String = "", Optional ByVal NOM_ENTREPRISE As String = "") As Boolean

        Dim updateQuery As String = "UPDATE `reservation` SET `CODE_RESERVATION`=@value1,`CLIENT_ID`=@value2,`UTILISATEUR_ID`=@value3,`CHAMBRE_ID`=@value4,
    `AGENCE_ID`=@value5,`NOM_CLIENT`=@NOM_CLIENT,`DATE_ENTTRE`=@value6,`HEURE_ENTREE`=@value7,`DATE_SORTIE`=@value8,`HEURE_SORTIE`=@value9,`ADULTES`=@value10,
    `NB_PERSONNES`=@value11,`ENFANTS`=@value12,`RECEVOIR_EMAIL`=@value13,`RECEVOIR_SMS`=@value14,`ETAT_RESERVATION`=@value15,`DATE_CREATION`=@value16,
`HEURE_CREATION`=@value17,`MONTANT_TOTAL_CAUTION`=@value18,`MOTIF_ETAT`=@value19,`DATE_ETAT`=@value20,`MONTANT_ACCORDE`=@value21,`GROUPE`=@value22, 
DEPOT_DE_GARANTIE=@DEPOT_DE_GARANTIE , DAY_USE=@DAY_USE, MENSUEL=@MENSUEL, BC_ENTREPRISE=@BC_ENTREPRISE, TYPE_CHAMBRE=@TYPE_CHAMBRE, `TYPE`=@value23, 
PETIT_DEJEUNER_ROUTAGE=@value24, CHAMBRE_ROUTAGE=@value25, VENANT_DE=@value26, SE_RENDANT_A=@value27, RAISON=@value28, SOURCE_RESERVATION=@value29, ROUTAGE=@value30 ,
ETAT_NOTE_RESERVATION = @value31 , CODE_ENTREPRISE=@value32 , NOM_ENTREPRISE = @value33, HEBDOMADAIRE=@HEBDOMADAIRE WHERE CODE_RESERVATION=@CODE_RESERVATION"
    ...
    Public Function updateReservationConf(ByVal CODE_RESERVATION As String, ByVal CLIENT_ID As String, ByVal UTILISATEUR_ID As String, ByVal CHAMBRE_ID As String, ByVal AGENCE_ID As String, ByVal NOM_CLIENT As String, ByVal DATE_ENTTRE As Date, ByVal HEURE_ENTREE As DateTime, ByVal DATE_SORTIE As Date, ByVal HEURE_SORTIE As DateTime, ByVal ADULTES As Integer, ByVal NB_PERSONNES As Integer, ByVal ENFANTS As Integer, ByVal RECEVOIR_EMAIL As String, ByVal RECEVOIR_SMS As Integer, ByVal ETAT_RESERVATION As Integer, ByVal ETAT_RESERVATION_NOTE As String, ByVal DATE_CREATION As Date, ByVal HEURE_CREATION As DateTime, ByVal MONTANT_TOTAL_CAUTION As Double, ByVal MOTIF_ETAT As String, ByVal DATE_ETAT As Date, ByVal MONTANT_ACCORDE As Double, ByVal GROUPE As String, ByVal DEPOT_DE_GARANTIE As Double, ByVal DAY_USE As Integer, ByVal MENSUEL As Integer, ByVal HEBDOMADAIRE As Integer, ByVal BC_ENTREPRISE As String, ByVal TYPE_CHAMBRE As String, Optional ByVal PETIT_DEJEUNER_ROUTAGE As Double = 0, Optional ByVal CHAMBRE_ROUTAGE As String = "", Optional ByVal VENANT_DE As String = "", Optional ByVal SE_RENDANT_A As String = "", Optional ByVal RAISON As String = "", Optional ByVal SOURCE_RESERVATION As String = "", Optional ByVal ROUTAGE As String = "NON", Optional ByVal ETAT_NOTE_RESERVATION As String = "", Optional ByVal CODE_ENTREPRISE As String = "", Optional ByVal NOM_ENTREPRISE As String = "") As Boolean
        ...
        Dim updateQuery As String = "UPDATE `reserve_conf` SET `CODE_RESERVATION`=@value1,`CLIENT_ID`=@value2,`UTILISATEUR_ID`=@value3,`CHAMBRE_ID`=@value4,
        `AGENCE_ID`=@value5,`NOM_CLIENT`=@NOM_CLIENT,`DATE_ENTTRE`=@value6,`HEURE_ENTREE`=@value7,`DATE_SORTIE`=@value8,`HEURE_SORTIE`=@value9,`ADULTES`=@value10,
        `NB_PERSONNES`=@value11,`ENFANTS`=@value12,`RECEVOIR_EMAIL`=@value13,`RECEVOIR_SMS`=@value14,`ETAT_RESERVATION`=@value15,`ETAT_NOTE_RESERVATION`=@ETAT_NOTE_RESERVATION,
        `DATE_CREATION`=@value16,`HEURE_CREATION`=@value17,`MONTANT_TOTAL_CAUTION`=@value18,`MOTIF_ETAT`=@value19,`DATE_ETAT`=@value20,`MONTANT_ACCORDE`=@value21,
        `GROUPE`=@value22,DEPOT_DE_GARANTIE=@DEPOT_DE_GARANTIE, DAY_USE=@DAY_USE, MENSUEL=@MENSUEL,BC_ENTREPRISE =@BC_ENTREPRISE, TYPE_CHAMBRE =@TYPE_CHAMBRE, 
        PETIT_DEJEUNER_ROUTAGE=@value23, CHAMBRE_ROUTAGE=@value24, VENANT_DE=@value25, SE_RENDANT_A=@value26, RAISON=@value27 , SOURCE_RESERVATION=@value28, 
    ROUTAGE=@value29, CODE_ENTREPRISE=@value32 , NOM_ENTREPRISE = @value33, HEBDOMADAIRE =@HEBDOMADAIRE  WHERE CODE_RESERVATION=@CODE_RESERVATION"
    ...
    Public Function insertMainCouranteJournaliere(ByVal mainCouranteJournaliere As DataTable) As Boolean
        ...
        If infoResa.Rows.Count > 0 Then
            ...
            HEBDOMADAIRE = infoResa.Rows(0)("HEBDOMADAIRE")
    ...
    Public Function insertTrace(ByVal CODE_RESERVATION As String, ByVal CLIENT_ID As String, ByVal UTILISATEUR_ID As String, ByVal CHAMBRE_ID As String, ByVal AGENCE_ID As String, ByVal NOM_CLIENT As String, ByVal DATE_ENTTRE As Date, ByVal HEURE_ENTREE As DateTime, ByVal DATE_SORTIE As Date, ByVal HEURE_SORTIE As DateTime, ByVal ADULTES As Integer, ByVal NB_PERSONNES As Integer, ByVal ENFANTS As Integer, ByVal RECEVOIR_EMAIL As String, ByVal RECEVOIR_SMS As Integer, ByVal ETAT_RESERVATION As Integer, ByVal DATE_CREATION As Date, ByVal HEURE_CREATION As String, ByVal MONTANT_TOTAL_CAUTION As Double, ByVal MOTIF_ETAT As String, ByVal DATE_ETAT As Date, ByVal MONTANT_ACCORDE As Double, ByVal GROUPE As String, ByVal DEPOT_DE_GARANTIE As Double, ByVal DAY_USE As Integer, ByVal MENSUEL As Integer, ByVal HEBDOMADAIRE As Integer, ByVal BC_ENTREPRISE As String, ByVal TYPE_CHAMBRE As String, ByVal ACTION As String, ByVal PAR As String, Optional ByVal TYPE As String = "chambre", Optional ByVal PETIT_DEJEUNER_ROUTAGE As Double = 0, Optional ByVal CHAMBRE_ROUTAGE As String = "", Optional ByVal VENANT_DE As String = "", Optional ByVal SE_RENDANT_A As String = "", Optional ByVal RAISON As String = "", Optional ByVal SOURCE_RESERVATION As String = "", Optional ByVal ROUTAGE As String = "NON", Optional ByVal ETAT_NOTE_RESERVATION As String = "", Optional ByVal CODE_ENTREPRISE As String = "", Optional ByVal NOM_ENTREPRISE As String = "", Optional ByVal SOLDE_RESERVATION As Double = 0) As Boolean
        ...
        `NOM_ENTREPRISE`, `SOLDE_RESERVATION`, `HEBDOMADAIRE`) 
        ...
        @value28,@value29,@value30,@value31,@value32, @value33, @SOLDE_RESERVATION, @HEBDOMADAIRE)"
