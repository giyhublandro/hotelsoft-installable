Public Class passwordVerifivationForm
                ...
                If infoUtilisateurATransferer.Rows(0)("PASSWORD_UTILISATEUR").Equals(GunaTextBoxPasswordVerification.Text) Then
                    ...
                    Else
                        ...
                        If GlobalVariable.DroitAccesDeUtilisateurConnect.Rows(0)("CAISSE_ENREGISTREUSE") = 1 Then
                            BarRestaurantCaisseEnregistreuseForm.TransfertDeBlocNoteAvantPassassionDeService(NEW_CODE_CAISSIER)
                        Else
            ...
            If GlobalVariable.ConnectedUser.Rows(0)("PASSWORD_UTILISATEUR").Equals(GunaTextBoxPasswordVerification.Text) Then
                ...
                If GlobalVariable.fenetreDouvervetureDeCaisse = "bar" Then
                    ...
                    If GlobalVariable.DroitAccesDeUtilisateurConnect.Rows(0)("CAISSE_ENREGISTREUSE") = 1 Then
                        ...
                        BarRestaurantCaisseEnregistreuseForm.GestionOuvertureDeCaisse()
                        BarRestaurantCaisseEnregistreuseForm.indicateurDEtatDeCaisse()
                    ...
                    ElseIf GlobalVariable.fenetreDouvervetureDeCaisse = "fast_food" Then

                        FastFoodForm.GestionOuvertureDeCaisse()
    ...
    Private Sub GunaButtonEnregistrer_KeyDown(sender As Object, e As KeyEventArgs) Handles GunaButtonEnregistrer.KeyDown
